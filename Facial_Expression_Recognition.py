...
model = get_model()
model.load_weights(r"D:\python_servers\Facial_EXpression\Copy of best_weights.h5")  # Load the saved weights

# Load LabelEncoder
def load_object(name):
    pickle_obj = open(rf"D:\python_servers\Facial_EXpression\Copy of {name}.pck", "rb")
